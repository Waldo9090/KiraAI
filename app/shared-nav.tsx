    ...
    >
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-2 mr-4">
          ...
          <div
            className="relative"
            onMouseEnter={() => setAiStudyOpen(true)}
            onMouseLeave={() => setAiStudyOpen(false)}
          >
            <button
              className={
                "px-3 py-1 rounded-md font-medium text-gray-800 dark:text-white group-hover:bg-purple-100 dark:group-hover:bg-purple-800/50 transition flex items-center" +
                (aiStudyOpen ? " bg-purple-100 dark:bg-purple-800/50" : "")
              }
              onClick={e => {
                e.preventDefault();
                setAiStudyOpen(open => !open);
              }}
              aria-haspopup="true"
              aria-expanded={aiStudyOpen}
            >
